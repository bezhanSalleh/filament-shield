...
class Stringer
{
    ...
    public function deindent(string $needle, int $spacesToRemove): self
    {
        if ($lineInfo = $this->findLine($needle)) {
            ...
            $newLine = substr($currentLine, $actualSpacesToRemove);
...
//             $this->content = substr_replace(
//                 $this->content,
//                 $lineInfo['indentation'] . trim($contentToPrepend) ,
//                 $lineInfo['start'],
//                 0
//             );
//         }
...
//     public function append(string $needle, string $contentToAppend, ?int $indent = 0): self
//     {
//         if ($lineInfo = $this->findLine($needle)) {
//             // Append the content with proper indentation
//             $this->content = substr_replace(
//                 $this->content,
//                 $lineInfo['indentation'] . str_repeat(' ', $indent) . trim($contentToAppend),
//                 $lineInfo['end'],
//                 0
//             );
//         }
...
//     public function replaceMany(array $needles, array $replacements): self
//     {
//         foreach ($needles as $index => $needle) {
//             $replacement = $replacements[$index] ?? '';
//             $this->replace($needle, $replacement);
//         }
...
//     // public function whenContains(string $needle, Closure $callback): self
//     // {
//     //     if ($this->contains($needle)) {
//     //         $callback($needle, $this);
//     //     }
